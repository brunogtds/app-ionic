                       ...
                       <IonLabel className="questions">Sobre a pandemia do Covid-19:</IonLabel> 
                        ...
                        <IonItem className={"ion-no-padding"}>
                            ...
                            <Controller render={({ onChange }) => (
                                ...
                                <IonList className={"ion-no-padding"}>
                                    ...
                                    <IonItem lines="none"  >
                                        <IonCheckbox className={"checkbox-options"} color="primary" value={props.getState("m1", false)} onIonChange={(e) => {

                                            console.log(e);
                                            onChange(e.detail.checked);
                                             if (e.detail.checked !== undefined){
                                           
                                              props.setState('m1', true + " m1q1") }
                                                
                                             else
                                                props.setState('m1', false)
                                        }}></IonCheckbox>
                        ...
                        <IonLabel className="questions">Sobre bons hábitos para se manter saudável:</IonLabel>
                         ...
                         <div className="ion-text-center">
                          <IonButton color="white" onClick={onSubmit}>OK, cadastrar!</IonButton>
                          </div>
