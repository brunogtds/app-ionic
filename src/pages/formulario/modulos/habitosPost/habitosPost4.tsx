                                ...
                                <IonItem lines="none">
                                    <Controller render={({ onChange }) => (
                                        <IonDatetime placeholder="Por favor, selecione..." display-format="HH:mm " picker-format="HH:mm" minuteValues="0,5,10,15,20,25,30,35,40,45,50,55" onIonChange={(e) => {
                                            ...
                                            onChange(e.detail.value);
                                            if (e.detail.value != undefined) {
                                                props.setState('lightTimingPost14', e.detail.value)
                                            }
                                        }}></IonDatetime>)} control={control} name={"lightTimingPost14"} rules={{ required: true }} />
                                ...
                                <IonItem lines="none">
                                    <Controller render={({ onChange }) => (
                                        <IonDatetime placeholder="Por favor, selecione..." display-format="HH:mm " picker-format="HH:mm" minuteValues="0,5,10,15,20,25,30,35,40,45,50,55" onIonChange={(e) => {
                                            ...
                                            onChange(e.detail.value);
                                            if (e.detail.value != undefined) {
                                                props.setState('lightTimingWDPost14', e.detail.value)
                                            }
                                        }}></IonDatetime>)} control={control} name={"lightTimingWDPost14"} rules={{ required: true }} />
                                ...
                                <IonItem lines="none">
                                    <Controller render={({ onChange }) => (
                                        <IonDatetime placeholder="Por favor, selecione..." display-format="HH:mm " picker-format="HH:mm" minuteValues="0,5,10,15,20,25,30,35,40,45,50,55" onIonChange={(e) => {
                                            ...
                                            onChange(e.detail.value);
                                            if (e.detail.value != undefined) {
                                                props.setState('lightTimingFDPost14', e.detail.value)
                                            }
                                        }}></IonDatetime>)} control={control} name={"lightTimingFDPost14"} rules={{ required: true }} />
