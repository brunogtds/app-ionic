...
const RMeqFinal = (props: StepComponentProps) => {
                        ...
                        <div className="container">
                          ...
                          <IonItem lines="none">
                                        <Controller render={({ onChange }) => (
                                            <IonSelect interfaceOptions={options} className={"select-interface-option"}  okText="ok" cancelText="Cancelar" placeholder="Por favor, selecione..."  onIonChange={(e) => {
                                                ...
                                                if (e.detail.value != undefined) {
                                                   // setLightReg(e.detail.value);
                                                    props.setState('rmeq01Final', e.detail.value)
                                                }
                                            }}>
                                            ...
                                            </IonSelect>)} control={control} name={"rmeq01Final"} rules={{ required: true }} />
                        ...
                        <IonItem lines="none">
                                        <Controller render={({ onChange }) => (
                                            <IonSelect interfaceOptions={options} className={"select-interface-option"}  okText="ok" cancelText="Cancelar" placeholder="Por favor, selecione..."  onIonChange={(e) => {
                                                ...
                                                if (e.detail.value != undefined) {
                                                   // setLightReg(e.detail.value);
                                                    props.setState('rmeq02Final', e.detail.value)
                                                }
                                            }}>
                                            ...
                                            </IonSelect>)} control={control} name={"rmeq02Final"} rules={{ required: true }} />
                                    ...
                                    <IonItem lines="none">
                                        <Controller render={({ onChange }) => (
                                            <IonSelect interfaceOptions={options} className={"select-interface-option"}  okText="ok" cancelText="Cancelar" placeholder="Por favor, selecione..."  onIonChange={(e) => {
                                                ...
                                                if (e.detail.value != undefined) {
                                                   // setLightReg(e.detail.value);
                                                    props.setState('rmeq03Final', e.detail.value)
                                                }
                                            }}>
                                            ...
                                            </IonSelect>)} control={control} name={"rmeq03Final"} rules={{ required: true }} />
                       ...
                       <IonItem lines="none">
                                        <Controller render={({ onChange }) => (
                                            <IonSelect interfaceOptions={options} className={"select-interface-option"}  okText="ok" cancelText="Cancelar" placeholder="Por favor, selecione..."  onIonChange={(e) => {
                                                ...
                                                if (e.detail.value != undefined) {
                                                   // setLightReg(e.detail.value);
                                                    props.setState('rmeq04Final', e.detail.value)
                                                }
                                            }}>
                                            ...
                                            </IonSelect>)} control={control} name={"rmeq04Final"} rules={{ required: true }} />
                        ...
                        <IonItem lines="none">
                                        <Controller render={({ onChange }) => (
                                            <IonSelect interfaceOptions={options} className={"select-interface-option"}  okText="ok" cancelText="Cancelar" placeholder="Por favor, selecione..."  onIonChange={(e) => {
                                                ...
                                                if (e.detail.value != undefined) {
                                                   // setLightReg(e.detail.value);
                                                    props.setState('rmeq05Final', e.detail.value)
                                                }
                                            }}>
                                            ...
                                            </IonSelect>)} control={control} name={"rmeq05Final"} rules={{ required: true }} />
