...
const RMeqPost = (props: StepComponentProps) => {
                        ...
                        <div className="container">
                          ...
                          <IonItem lines="none">
                                        <Controller render={({ onChange }) => (
                                            <IonSelect interfaceOptions={options} className={"select-interface-option"}  okText="ok" cancelText="Cancelar" placeholder="Por favor, selecione..."  onIonChange={(e) => {
                                                ...
                                                if (e.detail.value != undefined) {
                                                   // setLightReg(e.detail.value);
                                                    props.setState('rmeq01Post', e.detail.value)
                                                }
                                            }}>
                                            ...
                                            </IonSelect>)} control={control} name={"rmeq01Post"} rules={{ required: true }} />
                        ...
                        <IonItem lines="none">
                                        <Controller render={({ onChange }) => (
                                            <IonSelect interfaceOptions={options} className={"select-interface-option"}  okText="ok" cancelText="Cancelar" placeholder="Por favor, selecione..."  onIonChange={(e) => {
                                                ...
                                                if (e.detail.value != undefined) {
                                                   // setLightReg(e.detail.value);
                                                    props.setState('rmeq02Post', e.detail.value)
                                                }
                                            }}>
                                            ...
                                            </IonSelect>)} control={control} name={"rmeq02Post"} rules={{ required: true }} />
                                    ...
                                    <IonItem lines="none">
                                        <Controller render={({ onChange }) => (
                                            <IonSelect interfaceOptions={options} className={"select-interface-option"}  okText="ok" cancelText="Cancelar" placeholder="Por favor, selecione..."  onIonChange={(e) => {
                                                ...
                                                if (e.detail.value != undefined) {
                                                   // setLightReg(e.detail.value);
                                                    props.setState('rmeq03Post', e.detail.value)
                                                }
                                            }}>
                                            ...
                                            </IonSelect>)} control={control} name={"rmeq03Post"} rules={{ required: true }} />
                       ...
                       <IonItem lines="none">
                                        <Controller render={({ onChange }) => (
                                            <IonSelect interfaceOptions={options} className={"select-interface-option"}  okText="ok" cancelText="Cancelar" placeholder="Por favor, selecione..."  onIonChange={(e) => {
                                                ...
                                                if (e.detail.value != undefined) {
                                                   // setLightReg(e.detail.value);
                                                    props.setState('rmeq04Post', e.detail.value)
                                                }
                                            }}>
                                            ...
                                            </IonSelect>)} control={control} name={"rmeq04Post"} rules={{ required: true }} />
                        ...
                        <IonItem lines="none">
                                        <Controller render={({ onChange }) => (
                                            <IonSelect interfaceOptions={options} className={"select-interface-option"}  okText="ok" cancelText="Cancelar" placeholder="Por favor, selecione..."  onIonChange={(e) => {
                                                ...
                                                if (e.detail.value != undefined) {
                                                   // setLightReg(e.detail.value);
                                                    props.setState('rmeq05Post', e.detail.value)
                                                }
                                            }}>
                                            ...
                                            </IonSelect>)} control={control} name={"rmeq05Post"} rules={{ required: true }} />
