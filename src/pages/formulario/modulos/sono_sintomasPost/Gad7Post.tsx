...
const Gad7Post = (props: StepComponentProps) => {
                            ...
                            <Controller render={({ onChange }) => (
                                ...
                                <IonRadioGroup onIonChange={(e) => {
                                    ...
                                    if (e.detail.value != undefined) {
                                        props.setState('gad7Post14_gad01', e.detail.value)
                                    }
                                }}>
                                ...
                                </IonRadioGroup>)} control={control} name={"gad7Post14_gad01"} rules={{ required: true }} />

                        </IonItem>
                        {errors.gad7Post14_gad01 && <IonText color="danger">Campo obrigatório.</IonText>}
                        ...
                        <IonItem lines="none" className={"ion-no-padding"}>
                            ...
                            <Controller render={({ onChange }) => (
                                ...
                                <IonRadioGroup onIonChange={(e) => {
                                    ...
                                    onChange(e.detail.value);
                                    if (e.detail.value != undefined) {
                                        props.setState('gad7Post14_gad02', e.detail.value)
                                    }
                                }}>
                                ...
                                </IonRadioGroup>)} control={control} name={"gad7Post14_gad02"} rules={{ required: true }} />
                            {errors.gad7Post14_gad02 && <IonText color="danger">Campo obrigatório.</IonText>}
                        </IonItem>
                        ...
                        <IonItem lines="none" className={"ion-no-padding"}>
                            ...
                            <Controller render={({ onChange }) => (
                                ...
                                <IonRadioGroup onIonChange={(e) => {
                                    ...
                                    onChange(e.detail.value);
                                    if (e.detail.value != undefined) {
                                        props.setState('gad7Post14_gad03', e.detail.value)
                                    }
                                }}>
                                ...
                                </IonRadioGroup>)} control={control} name={"gad7Post14_gad03"} rules={{ required: true }} />
                            {errors.gad7Post14_gad03 && <IonText color="danger">Campo obrigatório.</IonText>}
                        </IonItem>
                        ...
                        <IonItem lines="none" className={"ion-no-padding"}>
                            ...
                            <Controller render={({ onChange }) => (
                                ...
                                <IonRadioGroup onIonChange={(e) => {
                                    ...
                                    onChange(e.detail.value);
                                    if (e.detail.value != undefined) {
                                        props.setState('gad7Post14_gad04', e.detail.value)
                                    }
                                }}>
                                ...
                                </IonRadioGroup>)} control={control} name={"gad7Post14_gad04"} rules={{ required: true }} />
                            {errors.gad7Post14_gad04 && <IonText color="danger">Campo obrigatório.</IonText>}
                        </IonItem>
                        ...
                        <IonItem lines="none" className={"ion-no-padding"}>
                            ...
                            <Controller render={({ onChange }) => (
                                ...
                                <IonRadioGroup onIonChange={(e) => {
                                    ...
                                    onChange(e.detail.value);
                                    if (e.detail.value != undefined) {
                                        props.setState('gad7Post14_gad05', e.detail.value)
                                    }
                                }}>
                                ...
                                </IonRadioGroup>)} control={control} name={"gad7Post14_gad05"} rules={{ required: true }} />
                            {errors.gad7Post14_gad05 && <IonText color="danger">Campo obrigatório.</IonText>}
                        ...
                        <IonItem lines="none" className={"ion-no-padding"}>
                            ...
                            <Controller render={({ onChange }) => (
                                ...
                                <IonRadioGroup onIonChange={(e) => {
                                    ...
                                    onChange(e.detail.value);
                                    if (e.detail.value != undefined) {
                                        props.setState('gad7Post14_gad06', e.detail.value)
                                    }
                                }}>
                                ...
                                </IonRadioGroup>)} control={control} name={"gad7Post14_gad06"} rules={{ required: true }} />
                            {errors.gad7Post14_gad06 && <IonText color="danger">Campo obrigatório.</IonText>}
                        </IonItem>
                        ...
                        <IonItem lines="none" className={"ion-no-padding"}>
                            ...
                            <Controller render={({ onChange }) => (
                                ...
                                <IonRadioGroup onIonChange={(e) => {
                                    ...
                                    onChange(e.detail.value);
                                    if (e.detail.value != undefined) {
                                        props.setState('gad7Post14_gad07', e.detail.value)
                                    }
                                }}>
                                ...
                                </IonRadioGroup>)} control={control} name={"gad7Post14_gad07"} rules={{ required: true }} />
                            {errors.gad7Post14_gad07 && <IonText color="danger">Campo obrigatório.</IonText>}
