...
const ContatoPost1 = (props: StepComponentProps) => {
                        ...
                        <div className="ion-text-wrap">
                            ...
                            <IonItem lines="none">
                                ...
                                <Controller render={({ onChange }) => (
                                    ...
                                    <IonSelect className={"select-interface-option"} okText="ok" cancelText="Cancelar" placeholder="Por favor, selecione..." value={distanciamento} onIonChange={(e) => {
                                        setDistanciamento(e.detail.value);
                                        onChange(e.detail.value);
                                        console.log(e);
                                        if (e.detail.value != undefined)
                                            props.setState('socialDistPost14', 'nenhuma')
                                    }}>
                                    ...
                                    </IonSelect>)} control={control} name={'socialDistPost'} rules={{ required: true }} />
                                {errors.socialDistPost14 && <IonText color="danger">Campo obrigatório.</IonText>}
                            </IonItem>
                            ...
                            <IonItem lines="none" className={"ion-no-padding"}>
                                ...
                                <Controller render={({ onChange }) => (
                                    <IonRadioGroup value={isolamento} onIonChange={(e) => {
                                        setIsolamento(e.detail.value);
                                        onChange(e.detail.value);
                                        if (e.detail.value != undefined)
                                            props.setState('quarantineRoomPost14', e.detail.value)
                                    }}>
                                    ...
                                    </IonRadioGroup>)} rules={{ required: true }} control={control} name={"quarantineRoomPost14"} />
                                {errors.quarantineRoomPost14 && <IonText color="danger">Campo obrigatório.</IonText>}
                            </IonItem>
