            ...
            <div className="ion-text-wrap">
                ...
                <IonLabel className="questions">Com que frequência você praticou hobbies nas duas últimas semanas?</IonLabel>
                        <IonItem lines="none">
                            ...
                            {errors.hobbiesFreqFinal && <IonText color="danger">Campo obrigatório.</IonText>}
                         </IonItem>
                         ...
                         <IonItem lines="none" className={"ion-no-padding"}>
                            ...
                            {errors.exerciseFinal && <IonText color="danger">Campo obrigatório.</IonText>}
                        </IonItem> 
                        ...
                        <IonItem lines="none">
                            ...
                            {errors.exerciseFreqFinal&& <IonText color="danger">Campo obrigatório.</IonText>}
                         </IonItem>:null }
                         ...
                         <IonItem lines="none">
                            ...
                            {errors.exerciseRegFinal && <IonText color="danger">Campo obrigatório.</IonText>}
                          </IonItem>:null }
                        ...
                        {atividadeFisica === "sim" ? 
                         <IonItem lines="none">
                            ...
                            {errors.exerciseDurFinal && <IonText color="danger">Campo obrigatório.</IonText>}
                         </IonItem>:null }
                         </IonList>
                         ...
                         <IonItem lines="none">
                            ...
                            <IonItem lines="none">
                             ...
                             <IonDatetime placeholder="Por favor, selecione..." display-format="HH:mm " picker-format="HH:mm" minuteValues="0,5,10,15,20,25,30,35,40,45,50,55"  onIonChange={(e)=> {
                                ...
                                onChange(e.detail.value);
                                if (e.detail.value != undefined) {
                                props.setState('ExerciseTimingFinal', e.detail.value )} }}></IonDatetime> )} control={control} name={"ExerciseTimingFinal"} rules={{required:true}} />
                                {errors.ExerciseTimingFinal && <IonText color="danger">Campo obrigatório.</IonText>}
